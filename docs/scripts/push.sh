...
greed-summary -t "GreedPatch Document" -i '[scripts,resource,Resource,Publish,_book,node_modules,docs]' -d  ${BLOG_DIRECTORY}/ -o  ${BLOG_DIRECTORY}/README.md -S github -a
